...
// Variable
SDL_Color colorFond = {200, 200, 200, 255};
...
void showMainMenu(SDL_Renderer* renderer, int width, int height, TTF_Font* font) {
    SDL_SetRenderDrawColor(renderer, colorFond.r, colorFond.g, colorFond.b, colorFond.a);
    SDL_RenderClear(renderer);

    SDL_SetRenderDrawColor(renderer, colorFondBouton.r, colorFondBouton.g, colorFondBouton.b, colorFondBouton.a);
    SDL_Rect button = { width / 4, height / 3, width / 2, height / 5 };
    SDL_RenderFillRect(renderer, &button);

    SDL_SetRenderDrawColor(renderer, colorTextBouton.r, colorTextBouton.g, colorTextBouton.b, colorTextBouton.a);
